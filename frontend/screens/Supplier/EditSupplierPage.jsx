...
const validationSchema = Yup.object().shape({
    title: Yup.string().required().label('Supplier Name'),
    time: Yup.string().required().label('Preperation Time'),
    code: Yup.string().label('Supplier Code'),
...
const EditSupplierPage = () => {
    ...
    const editSupplier = async (values) => {
        ...
        try {
            ...
            await axios.put(`${baseUrl}/api/supplier/${item._id}`, formData, config);
                ...
                <View style={{ marginHorizontal: 20 }}>
                    ...
                    >
                        {({
                            ...
                            < View >
                                <Text style={styles.text}>Store Logo</Text>
