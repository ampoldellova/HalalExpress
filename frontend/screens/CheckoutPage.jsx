                    ...
                    <View style={{ borderColor: COLORS.gray2, height: 'auto', borderWidth: 1, borderRadius: 10, padding: 10, marginBottom: 20 }}>
                        ...
                        <TouchableOpacity
                            ...
                            style={{
                                ...
                                padding: 10,
                                borderRadius: 10,
                                borderColor: selectedPaymentMethod === 'gcash' ? COLORS.primary : COLORS.gray2,
                                opacity: restaurant?.delivery ? 1 : 0.5
                            }}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: '100%' }}>
                                <View style={{ flexDirection: 'row', alignItems: 'center', height: 30 }}>
                                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                        <Image source={require('../assets/images/gcash.png')} style={{ width: 27, height: 22, marginLeft: 2.5 }} />
                                        <Text style={{ fontFamily: 'medium', fontSize: 16, marginLeft: 10, color: COLORS.black }}>GCash</Text>
                                    </View>
                                </View>
                            </View>
