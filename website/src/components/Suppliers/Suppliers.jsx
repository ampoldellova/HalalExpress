        ...
        {suppliers.map((supplier) => (
          <Grid2 xs={12} sm={6} md={4}>
            <Card sx={{ maxWidth: 365, boxShadow: "none", cursor: "pointer" }}>
              <CardActionArea
                onClick={() =>
                  navigate(`/supplier/${supplier._id}`, { state: { supplier } })
                }
              >
                <CardMedia
                  sx={{
                ...
                <Grid2 container sx={{ alignItems: "center" }}>
                  <Box
                    ...
                    sx={{ height: 30, width: 30, borderRadius: 2 }}
                  />
                  <Box>
                    <Typography
                      sx={{ fontFamily: "medium", fontSize: 18, ml: 1, mt: 1 }}
                    >
                      {supplier.title}
                    </Typography>
                  </Box>
                ...
                >
                  <Typography
                    variant="body2"
                    sx={{ color: COLORS.gray, fontFamily: "regular" }}
                  >
                    Delivery Under
                  </Typography>
                  <Typography
